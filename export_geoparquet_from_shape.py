...
def convert_all_shapefiles_to_flatgeobuf():
    ...
    for shapefile in shapefiles:
        ...
        output_file = os.path.join(output_dir, base_name + ".fgb")
        ...
        try:
            ...
            QMessageBox.information(None, "Success", f"Shapefile successfully converted to FlatGeobuf: {output_file}")
        except Exception as e:
            QMessageBox.critical(None, f"Error with {shapefile}", f"Failed to convert shapefile to FlatGeobuf: {str(e)}")
            continue

# Run the function
convert_all_shapefiles_to_flatgeobuf()
